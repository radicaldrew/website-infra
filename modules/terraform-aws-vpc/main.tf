...
resource "aws_subnet" "public" {
  count = local.create_public_subnets && (!var.one_nat_gateway_per_az || local.len_public_subnets >= length(var.availability_zones)) ? local.len_public_subnets : 0
  ...
  tags = merge(
    {
      Name = try(
        ...
        format("${var.name}-${var.public_subnet_suffix}-%s", element(var.availability_zones, count.index))
      )
    },
    var.tags,
    var.public_subnet_tags,
    lookup(var.public_subnet_tags_per_az, element(var.availability_zones, count.index), {})
  )
}
  ...
  tags = merge(
    {
      Name = try(
        ...
        format("${var.name}-${var.private_subnet_suffix}-%s", element(var.availability_zones, count.index))
      )
    },
    var.tags,
    var.private_subnet_tags,
    lookup(var.private_subnet_tags_per_az, element(var.availability_zones, count.index), {})
  )
}
  ...
  tags = merge(
    {
      Name = try(
        ...
        format("${var.name}-${var.database_subnet_suffix}-%s", element(var.availability_zones, count.index), )
      )
    },
    var.tags,
  ...
  tags = merge(
    {
      Name = try(
        ...
        format("${var.name}-${var.redshift_subnet_suffix}-%s", element(var.availability_zones, count.index))
      )
    },
    var.tags,
  ...
  tags = merge(
    {
      Name = try(
        ...
        format("${var.name}-${var.elasticache_subnet_suffix}-%s", element(var.availability_zones, count.index))
      )
    },
    var.tags,
  ...
  tags = merge(
    {
      Name = try(
        ...
        format("${var.name}-${var.intra_subnet_suffix}-%s", element(var.availability_zones, count.index))
      )
    },
    var.tags,
